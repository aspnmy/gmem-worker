...
从 [Releases](https://github.com/aspnmy/gmem-worker/releases) 页面下载对应平台的可执行文件。
...
- [GitHub 仓库](https://github.com/aspnmy/gmem-worker)
- [设计文档](https://github.com/aspnmy/gmem-worker/blob/main/AppProjects/gmem_rust_memory_store/docs/gmem_rust_memory_store项目设计.md)
